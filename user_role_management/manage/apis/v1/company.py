...
class CompanyGroupsApi(APIView):
    ...
    @extend_schema(request=InputCompanyGroupSerializer, responses=CustomCompanyGroupSingleResponseSerializer, tags=['CompanyGroup'])
    def post(self, request: HttpRequest):
...
class CompanyGroupApi(APIView):
    ...
    @extend_schema(responses=CustomCompanyGroupSingleResponseSerializer, tags=['CompanyGroup'])
    ...
    @extend_schema(request=UpdateCompanyGroupSerializer, responses=CustomCompanyGroupSingleResponseSerializer, tags=['CompanyGroup'])
