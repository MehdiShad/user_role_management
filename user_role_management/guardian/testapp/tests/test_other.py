...
import user_role_management.guardian as guardian
from user_role_management.guardian.backends import ObjectPermissionBackend
from user_role_management.guardian.compat import get_user_model_path
from user_role_management.guardian.compat import get_user_permission_codename
from user_role_management.guardian.exceptions import GuardianError
from user_role_management.guardian.exceptions import NotUserNorGroup
from user_role_management.guardian.exceptions import ObjectNotPersisted
...
from user_role_management.guardian.testapp.tests.conf import TestDataMixin
User = get_user_model()
...
class UserPermissionTests(TestDataMixin, TestCase):
    ...
    def test_assign_perm_validation(self):
        ...
        group = Company_group.objects.create(name='test_group_assign_perm_validation')
...
class GroupPermissionTests(TestDataMixin, TestCase):
    ...
    def test_errors(self):
        not_saved_group = Company_group(name='not_saved_group')
        self.assertRaises(ObjectNotPersisted,
...
class ObjectPermissionBackendTests(TestCase):
    ...
    def test_obj_is_not_model(self):
        for obj in (Company_group, 666, "String", [2, 1, 5, 7], {}):
