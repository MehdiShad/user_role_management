...
from user_role_management.guardian.decorators import permission_required, permission_required_or_403, permission_required_or_404
...
from user_role_management.guardian.testapp.tests.conf import override_settings
...
class PermissionRequiredTest(TestDataMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.group = Company_group.objects.get_or_create(name='jackGroup')[0]
    ...
    def test_redirection_raises_wrong_app_error(self):
        from usermanagement.guardian.testapp.models import Project
        request = self._get_request(self.user)
